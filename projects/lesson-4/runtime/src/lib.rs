...
/// Used for the module avalon in `./avalon.rs`
mod avalon;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("substrate-avalon"),
	impl_name: create_runtime_str!("substrate-avalon"),
	authoring_version: 3,
	spec_version: 4,
	impl_version: 4,
...
/// Used for the module avalon in `./avalon.rs`
 impl avalon::Trait for Runtime {
	 type GundamNumber = u32;
 }
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Sudo: sudo,
		// Used for the module avalon in `./avalon.rs`
		AvalonModule: avalon::{Module, Call, Storage},
